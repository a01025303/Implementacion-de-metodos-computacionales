...
#{final_token}
    ...
    def parallel_regex(fileList, threads \\ System.schedulers), 
        do: parallel_regex_rec(fileList, threads, div(Enum.count(fileList), threads), rem(Enum.count(fileList), threads))
...
ParallelHighlighter.parallel_regex(["out_file_000001.json", "out_file_000002.json", "out_file_000003.json"], 2)